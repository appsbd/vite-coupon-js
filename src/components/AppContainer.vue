...
<!--              <a href="#" @click="logout" style="cursor:pointer;">-->
<!--                <i class="vps  vps-power"></i>-->
<!--              </a>-->
            </slot>
          </div>
        </div>
      ...
      <div class="app-content-footer">
        <span class="apbd-cp" >
          <a href="https://appsbd.com/vite-coupon" target="_blank">Vite Coupon</a>, Copyright ©{{new Date().getFullYear()}}<a href="https://appsbd.com" target="_blank">Appsbd</a>. All rights reserved.
        </span>
        <span class="app-version"><translate>Version</translate>:{{ $appsbdUtls.AppVersion() }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    // async logout()
    // {
    //   let resp= await this.userStore.logoutAdmin();
    //   if(resp.status)
    //   {
    //     console.log(resp);
